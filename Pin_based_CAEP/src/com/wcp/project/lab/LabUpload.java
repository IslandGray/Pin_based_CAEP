...
public class LabUpload extends ActionSupport{
	...
	public String upload0() throws Exception{
		...
		try {
			...
			String realPath = servletContext.getRealPath("/WEB-INF/UserFiles"+"/"+id);
			//3.如果这个真实的目录不存在，需要创建
			...
			File newFile=new File(file,id+"_lab1-1.cpp");
			lab01file.renameTo(newFile);
			lab02file.renameTo(new File(file,id+"_lab1-2.cpp"));
