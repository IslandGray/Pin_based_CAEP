...
document.writeln("		        	<a class=\'nav-link\' href=\'#\'>Home</a>");
document.writeln("		      	</li>");
document.writeln("		      	<li class=\'nav-item dropdown\'>");
document.writeln("				    <a class=\'nav-link dropdown-toggle\' data-toggle=\'dropdown\' href=\'#\' role=\'button\' id=\'experiment\' data-target=\'#\' aria-haspopup=\'true\' aria-expanded=\'false\'>Experiment</a>");
document.writeln("				    <div class=\'dropdown-menu\' role=\'menu\' aria-labelledby=\'experiment\' x-placement=\'bottom-start\' style=\'position: absolute; transform: translate3d(0px, 41px, 0px); top: 0px; left: 0px; will-change: transform;\'>");
