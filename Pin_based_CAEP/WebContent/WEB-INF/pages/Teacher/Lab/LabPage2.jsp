				...
				<div class="col-md-10 column">
					...
					<div id="1c" style="display:none">
						<div class="card border-dark mb-3" style="">
						    ...
						    <div class="card-body">
								...
								<p></p>
								<form action="tealab0uploadPDF.action?upPath=/PDFsrc/Lab2.pdf" method="post" enctype="multipart/form-data">
						     	<fieldset>
					...
					<div id="3c" style="display:none">
						<div class="card border-dark mb-3" id="border" style="">
						    ...
						    <div class="card-body">
						    	<form action="editTime.action?labnum=2" method="post" enctype="multipart/form-data">
						    ...
						    <div class="card-body">
						    	...
						    	<table class="table table-hover" id="tableId">
									...
									<%
								 		ld=new LoadQuery();
								 		X2 x=new X2();
								 		List<Object> list=ld.query("X2");
								 		List<User> u=new ArrayList();
								 		for(Object i:list){
								 			String acc=((X2)i).getAccount();
								 	...
								 	%>
										<tr style="display:none;">
									      ...
									      <td><%=us.getName() %></td>
									      <td><%=us.getGroup() %></td>
									      <td><a href="devDownload.action?fileName=<%=id%>_lab2.cpp&filePath=/usr/services/pin-3.5/source/tools/ManualExamples/<%=id%>">lab2.cpp</a>
									      		/<a href="devDownload.action?fileName=BranchPredictor.h&filePath=/usr/services/pin-3.5/source/tools/ManualExamples/<%=id%>">BranchPredictor.h</a></td>
									      <td><a href="#" onclick="showDialog('<%=us.getAccount() %>')"><%=((X2)i).getExcute() %></a></td>
									    </tr>
								   <%
								 			}
								 		}
									...
									<%
								 		for(User i:u){
								 			if(groupList.contains(i.getGroup())){
								 				List<Object> ex=ld.query("Excute", "account", i.getAccount(), "number","lab2");
								 				X2 xx=(X2)(ld.queryRTN("X2", "account", i.getAccount(),""));
								 				String report=null;
								 				String h1=null;String h2=null;
								 				String c1=null;
								 				if(!ex.isEmpty()){
								 					report=String.valueOf(xx.getReport());
								 					h1="checkStuPDF.action?id="+i.getID()+"&filename="+i.getID()+"_lab2.pdf";
								 					h2="查看PDF";
...
<script type="text/javascript">
	...
	function showDialog(val) {
		...
		{
			;
			location.href="editExcute.action?labnum=2&acc="+val+"&to="+name;
		}
	}
	function showPDFDialog(val) {
		...
		{
			;
			location.href="editPDF.action?labnum=2&acc="+val+"&to="+name;
		}
	}
	function checkDup(){
