				...
				<div class="col-md-10 column">
					...
					<div id="1c" style="display:none">
						<div class="card border-dark mb-3" style="">
						    ...
						    <div class="card-body">
								...
								<p></p>
								<form action="tealab0uploadPDF.action?upPath=/PDFsrc/Lab1.pdf" method="post" enctype="multipart/form-data">
						     	<fieldset>
					...
					<div id="3c" style="display:none">
						<div class="card border-dark mb-3" id="border" style="">
						    ...
						    <div class="card-body">
						    	<form action="editTime.action?labnum=1" method="post" enctype="multipart/form-data">
						    ...
						    <div class="card-body">
						    	...
						    	<table class="table table-hover" id="tableId">
									...
									<%
								 		ld=new LoadQuery();
								 		X1 x=new X1();
								 		List<Object> list=ld.query("X1");
								 		List<User> u=new ArrayList();
								 		for(Object i:list){
								 			String acc=((X1)i).getAccount();
								 	...
								 	%>
										<tr style="display:none;">
									      ...
									      <td><%=us.getName() %></td>
									      <td><%=us.getGroup() %></td>
									      <td><a href="devDownload.action?fileName=<%=id%>_lab1.cpp&filePath=/usr/services/pin-3.5/source/tools/ManualExamples/<%=id%>">lab1.cpp</a>
									      		/<a href="devDownload.action?fileName=CacheModel.h&filePath=/usr/services/pin-3.5/source/tools/ManualExamples/<%=id%>">CacheModel.h</a></td>
									      <td><a href="#" onclick="showDialog('<%=us.getAccount() %>')"><%=((X1)i).getExcute() %></a></td>
									    </tr>
								   <%
								 			}
								 		}
									...
									<%
								 		for(User i:u){
								 			if(groupList.contains(i.getGroup())){
								 				List<Object> ex=ld.query("Excute", "account", i.getAccount(), "number","lab1");
								 				X1 xx=(X1)(ld.queryRTN("X1", "account", i.getAccount(),""));
								 				String report=null;
								 				String h1=null;String h2=null;
								 				String c1=null;
								 				if(!ex.isEmpty()){
								 					report=String.valueOf(xx.getReport());
								 					h1="checkStuPDF.action?id="+i.getID()+"&filename="+i.getID()+"_lab1.pdf";
								 					h2="查看PDF";
...
<script type="text/javascript">
	...
	function showDialog(val) {
		...
		{
			;
			location.href="editExcute.action?labnum=1&acc="+val+"&to="+name;
		}
	}
